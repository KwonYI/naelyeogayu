package com.a103.apiServer.Jwt;
...
//		Payload 설정
		jwtBuilder
			...
			.claim("user", member).claim("greeting", "환영합니다. " + member.getNickname()); // 담고 싶은 정보 설정.
//		signature 설정
...
//          인증 기간 만료
			throw new ResponseStatusException(HttpStatus.NOT_FOUND, "인증 토큰이 만료되었습니다.");
